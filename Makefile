...
ICONNAME=icons/nanos_app_changelly.gif
else ifeq ($(TARGET_NAME), TARGET_STAX)
ICONNAME=icons/stax_app_changelly.gif
DEFINES += ICONGLYPH=C_stax_changelly_64px
DEFINES += ICONBITMAP=C_stax_changelly_64px_bitmap
GLYPH_FILES += $(ICONNAME)
else
ICONNAME=icons/nanox_app_changelly.gif
endif
